...
dependencies:  
    ...
    dependency "castle.facilities"   >> "Castle.Facilities.ActiveRecordIntegration"
    dependency "castle.facilities"   >> "Castle.Facilities.AutomaticTransactionManagement"
    dependency "castle.facilities"   >> "Castle.Facilities.BatchRegistration"
    dependency "castle.facilities"   >> "Castle.Facilities.Cache"
    dependency "castle.facilities"   >> "Castle.Facilities.Logging"
    dependency "castle.facilities"   >> "Castle.Facilities.NHibernateIntegration"
